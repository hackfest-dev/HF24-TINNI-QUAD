package com.example.MaskingPink;
...
import com.example.MaskingPink.databinding.ActivityMainBinding;
...
public class MaskingPink extends AppCompatActivity implements OnFragmentInteractionListener  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.MaskingPink.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
    ...
    private MaskingPink thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","MaskingPink"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("MaskingPink.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    ...
    private native int naMain(String[] argv, MaskingPink pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("MaskingPink");
    }
