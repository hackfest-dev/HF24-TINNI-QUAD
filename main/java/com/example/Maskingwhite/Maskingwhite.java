package com.example.Maskingwhite;
...
import com.example.Maskingwhite.databinding.ActivityMainBinding;
...
public class Maskingwhite extends AppCompatActivity implements OnFragmentInteractionListener  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.Maskingwhite.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
    ...
    private Maskingwhite thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","Maskingwhite"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("Maskingwhite.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    ...
    private native int naMain(String[] argv, Maskingwhite pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("Maskingwhite");
    }
